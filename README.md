...
This will compile the project and store the build artifacts in the `dist/destroyOceanCity` directory. By default, the production build optimizes your application for performance and speed.
